...
use crate::repositories::pokemon::{ Repository, InMemoryRepository, Insert };
// use crate::repositories::pokemon::Mock

use super::entities::{ PokemonNumber, PokemonName, PokemonTypes };
...
pub fn execute(req: Request, repo: Arc<dyn Repository>) -> Response {
    match
        (
